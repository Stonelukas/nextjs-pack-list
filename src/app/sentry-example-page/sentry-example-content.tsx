...
export default function SentryExampleContent() {
    ...
    <div>
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://lukas-n7.sentry.io/issues/?project=4509951087214672">Issues Page</a>.
