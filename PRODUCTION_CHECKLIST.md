...
- [x] `bun run check` passes lint, strict typecheck, 388 client Vitest tests across 89 files, and build.
- [x] ESLint exits with zero errors and 20 recorded warnings; warnings are not described as ignored application errors.
- [x] `bun run test:convex` passes 146 authorization, webhook, migration, and domain tests across eight files.
